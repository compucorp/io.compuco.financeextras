...
class UpdateContributionExchangeRate {
  ...
  private function updateSalesTaxCurrency() {
    ...
    \Civi\Api4\Contribution::update(FALSE)
      ->addWhere('id', '=', $this->form->_id)
      ->addValue('financeextras_currency_exchange_rates.sales_tax_currency', $salesTaxCurrency)
      ->addValue('financeextras_currency_exchange_rates.rate_1_unit_tax_currency', $exchangeRate['base_to_conversion_rate'])
      ->addValue('financeextras_currency_exchange_rates.rate_1_unit_contribution_currency', $exchangeRate['conversion_to_base_rate'])
      ->execute();
  }
