 ...
 * (GenCodeChecksum:4436581d7a8cc01f194268ef06677b88)
 */
...
class CRM_Financeextras_DAO_CreditNote extends CRM_Core_DAO {
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'owner_organization', 'civicrm_contact', 'id');
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'owner_organization' => [
          ...
          'type' => CRM_Utils_Type::T_INT,
          'title' => E::ts('Owner Organisation'),
          'description' => E::ts('FK to Contact'),
          'where' => 'financeextras_credit_note.owner_organization',
          'export' => TRUE,
          'table_name' => 'financeextras_credit_note',
          'entity' => 'CreditNote',
          'bao' => 'CRM_Financeextras_DAO_CreditNote',
