 ...
 */
function _financeextras_civix_civicrm_xmlMenu(&$files) {
  foreach (_financeextras_civix_glob(__DIR__ . '/xml/Menu/*.xml') as $file) {
    $files[] = $file;
  }
}
 ...
 * @return array
 */
function _financeextras_civix_find_files($dir, $pattern) {
 ...
 */
function _financeextras_civix_civicrm_managed(&$entities) {
  $mgdFiles = _financeextras_civix_find_files(__DIR__, '*.mgd.php');
  sort($mgdFiles);
 ...
 */
function _financeextras_civix_civicrm_caseTypes(&$caseTypes) {
  if (!is_dir(__DIR__ . '/xml/case')) {
    return;
  }

  foreach (_financeextras_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
 ...
 */
function _financeextras_civix_civicrm_angularModules(&$angularModules) {
  if (!is_dir(__DIR__ . '/ang')) {
    return;
  }

  $files = _financeextras_civix_glob(__DIR__ . '/ang/*.ang.php');
 ...
 */
function _financeextras_civix_civicrm_themes(&$themes) {
  $files = _financeextras_civix_glob(__DIR__ . '/*.theme.php');
  foreach ($files as $file) {
 ...
 * @return array
 */
function _financeextras_civix_glob($pattern) {
  $result = glob($pattern);
 ...
 */
function _financeextras_civix_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
