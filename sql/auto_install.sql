...
CREATE TABLE `financeextras_company` (
  ...
  `sales_tax_registration_number` VARCHAR(255) DEFAULT NULL,
  `display_currency_conversion_for_tax_on_invoices` TINYINT DEFAULT 0,
  `sales_tax_currency` VARCHAR(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
